...
// History holds arrays of all previously made entries (an entry is represented as an object).
let history;

// FS checks if a file called history.json exists.
if (fs.existsSync("history.json")) {

    // If it does, fs will read and load the string into the data variable.
